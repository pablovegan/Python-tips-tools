...
from mypackage import Vector, Rotation, Shear, LinearMap
...
@pytest.mark.parametrize(("rotation", "vector", "result"), ((R1, V1, V1), (R1, V2, V2), (R2, V1, V1), (R2, V2, V2)))
...
@pytest.mark.parametrize(("shear", "vector", "result"), ((S1, V1, V1), (S1, V2, V2), (S2, V1, V1), (S2, V2, V2)))
